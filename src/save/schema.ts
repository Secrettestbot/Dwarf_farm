...
export interface SavedDwarf {
  ...
  carrying?: { kind: "stone" | "ore" | "dirt" | "gem" | "bars" | "tools" | "food" | "drink" | "meal" | "wood" | "hide" | "bed" | "barrel" | "table" | "bin"; quality?: number };
...
export interface SavedItem {
  kind: "stone" | "ore" | "dirt" | "gem" | "bars" | "tools" | "food" | "drink" | "meal" | "wood" | "hide" | "bed" | "barrel" | "table" | "bin";
  x: number;
  y: number;
