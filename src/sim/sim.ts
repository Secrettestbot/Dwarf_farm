...
import { narrateOreFirstStrike, narratePairing, narrateBirth, narrateHostileSpawn, narrateHostileSlain, narrateArrival } from "./events/narrator";
...
import { hollowKingSystem, hollowKingManifestSystem, HOLLOW_KING_VICTORY_THRESHOLD } from "./systems/hollowKing";
...
import {
  ...
  kingSystem, argumentSystem, reconciliationSystem, festivalSystem,
  passiveTraitSystem, grudgeCount,
} from "./systems/social";

// Re-export for existing consumers (tests, dwarf inspector).
export { grudgeCount };
